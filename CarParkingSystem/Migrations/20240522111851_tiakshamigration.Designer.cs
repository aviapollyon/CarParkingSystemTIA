...
namespace CarParkingSystem.Migrations
{
    ...
    [Migration("20240522111851_tiakshamigration")]
    partial class tiakshamigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarParkingSystem.Models.Fault", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FaultReportedId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FaultReportedId");

                    b.ToTable("Fault");
                });

            modelBuilder.Entity("CarParkingSystem.Models.FaultReported", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarParkingSystem.Models.Noticeboard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarParkingSystem.Models.TechnicianReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarParkingSystem.Models.Fault", b =>
                {
                    b.HasOne("CarParkingSystem.Models.FaultReported", "FaultReported")
                        .WithMany()
                        .HasForeignKey("FaultReportedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FaultReported");
                });

            modelBuilder.Entity("CarParkingSystem.Models.TechnicianReport", b =>
                {
                    b.HasOne("CarParkingSystem.Models.Fault", "Fault")
                        .WithMany()
